...
This is the wallet where the MasterNode collateral will have to be transferred to and stored. After the setup is complete, this wallet will be the one receiving the rewards and doesn't have to run 24/7.
 ...
 * Download the newest Rupaya Qt wallet from: https://github.com/rupaya-project/rupx/releases
...
10. Go to MasterNodes tab and check if your newly added MasterNode is listed.
	...
	If you want to control multiple MasterNode Hot wallets from this Cold wallet, you will need to repeat the previous steps 1-7. The `masternode.conf` file will contain an entry for each MasterNode that will be added to the network.
